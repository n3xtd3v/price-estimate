...
function EnhancedTableToolbar(props) {
  const { numSelected, title, selected, dispatch, auth } = props;

  const handleClickSwitchIsActive = () => {
  ...
  const handleClickTakeRoleSupervisor = () => {
    dispatch(takeRoleSupervisor(auth, { selected }));
  };

  const handleClickTakeRoleSafff = () => {
    dispatch(takeRoleStaff(auth, { selected }));
  };
  ...
  return (
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        >
          <Tooltip
            title="Take the role admin"
            onClick={handleClickTakeRoleAdmin}
          >
            <IconButton>
          ...
          <Tooltip
            title="Take the role supervisor"
            onClick={handleClickTakeRoleSupervisor}
          >
            <IconButton>
              <ManageAccountsIcon />
            </IconButton>
          ...
          <Tooltip
            title="Take the role staff"
            onClick={handleClickTakeRoleSafff}
          >
            <IconButton>
              <PersonIcon />
            </IconButton>
...
export default function DataTable({ title, cells, rows, auth }) {
